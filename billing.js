    ...
    addToCartButtons.forEach((button, index) => {
        ...
        function updateCartItemList() {
            ...
            cartItems.forEach((item, index) => {
                ...
                <button class="remove--item" data-index="${index}"><img src="images/basket.JPG" class="fa-solid fa-times"></button>
                </span>
                `;
